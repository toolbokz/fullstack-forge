...
export const contentPlan = [
    {
        ...
        title: 'How Much Does a Website Cost in NZ? (2026 Price Guide)',
        description: 'A complete breakdown of website costs in New Zealand for 2026 — from DIY to agency pricing and what you actually need.',
    ...
    },
    {
        ...
        keyword: 'website for tradies NZ',
        title: 'Why Every Tradie in NZ Needs a Website in 2026',
        description: 'Plumbers, electricians, builders — stop relying on referrals alone. A simple website can double your lead flow.',
        intent: 'commercial',
        linksTo: ['/affordable-websites-nz', '/website-design-for-small-business'],
    ...
    },
    {
        ...
        title: 'How to Get More Leads From Your Website (Without More Traffic)',
        description: 'You don\'t always need more traffic — you need better conversion. Here are 7 proven tactics.',
        intent: 'informational',
        linksTo: ['/', '/website-design-for-small-business'],
